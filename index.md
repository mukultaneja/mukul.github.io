...
<div class="page-content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-4">
                <div>
                    <figure class="figure h-75 w-100 mt-5">
                        <img src="static/images/1567535066215.jpg" alt="mukul taneja" class="me img-responsive w-100 h-100"/>
                    </figure>
                </div>
                <div class="w-100">
                    <p class="text-center">Mukul Taneja</p>
                </div>
                <div>
                    <p>data enthusiast, data viz expert, full stack developer, passionate programmer, quick learner, loves to read books and listen to music</p>
                </div>
                <ul class="list-group">
                    <li aria-label="Org: VMware">
                        ...
                        <span>Senior Member of Technical Staff @VMware</span>
                    </li>
